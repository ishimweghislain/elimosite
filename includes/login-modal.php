    ...
    if (isset($_POST['login_form'])) {
        ...
        if (!empty($username) && !empty($password)) {
            try {
                ...
                if ($user && password_verify($password, $user['password'])) {
                    ...
                    echo '<script>window.location.href = "' . ($user['role'] === 'admin' ? ADMIN_URL : 'index.php') . '";</script>';
                    exit;
                } else {
                    $auth_message = '<div class="alert alert-danger">Invalid username or password</div>';
                }
            } catch (PDOException $e) {
                $auth_message = '<div class="alert alert-danger">Database error. Please try again.</div>';
            }
        } else {
            $auth_message = '<div class="alert alert-danger">Please enter username and password</div>';
        }
        ...
        if (!empty($full_name) && !empty($username) && !empty($email) && !empty($password)) {
            try {
                ...
                if ($stmt->fetch()) {
                    $auth_message = '<div class="alert alert-danger">Username or email already exists</div>';
                } else {
                    // Create new user
                    ...
                    $user_id = insert_record('users', $data);
                    if ($user_id) {
                        ...
                        $auth_message = '<div class="alert alert-danger">Registration failed. Please try again.</div>';
                    }
                }
            } catch (PDOException $e) {
                $auth_message = '<div class="alert alert-danger">Database error. Please try again.</div>';
            ...
            $auth_message = '<div class="alert alert-danger">Please fill in all required fields</div>';
        }
    }
}
?>
      ...
      <div class="modal-body p-4 py-sm-7 px-sm-8">
        ...
        <div class="tab-content shadow-none p-0" id="myTabContent">
          ...
          <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
            <form class="form" method="POST">
              ...
              <div class="form-group mb-4">
                ...
                <div class="input-group input-group-lg">
                  ...
                  <input type="text" class="form-control border-0 shadow-none fs-13"
                                       id="full-name" name="full_name" required
              ...
              <div class="form-group mb-4">
                ...
                <div class="input-group input-group-lg">
                  ...
                  <input type="text" class="form-control border-0 shadow-none fs-13"
                                       id="username01" name="username" required
                                       placeholder="Username / Your email">
                </div>
              </div>
              <div class="form-group mb-4">
            ...
            <div class="mt-2">By creating an account, you agree to <?php echo get_setting('site_name'); ?>

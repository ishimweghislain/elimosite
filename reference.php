...
<?php
    ...
    $AllAgents = "SELECT * FROM fx_account_details WHERE type = 'Agent'";

    try{
        $queryAgents = $db->prepare($AllAgents);

        $queryAgents->execute();

        $queryAgents->setFetchMode(PDO::FETCH_ASSOC);

        $rowAgents = $queryAgents->fetch();
    ...
    $SqlAllProperties = "SELECT * FROM fx_properties WHERE status = 'Active'";
    $rec_limit = 9;
    $page = 1;
    $offset = 0;
    try{
        $queryCount = $db->prepare($SqlAllProperties);
    ...
    // Select posts
    $SqlProperties = "SELECT * FROM fx_properties WHERE status = 'Active' ORDER BY id DESC LIMIT ". $offset . ", " . $rec_limit;

    try{
        $queryPost = $db->prepare($SqlProperties);
    ...
    //Select Author Data
    $sqlAgent= "SELECT * FROM fx_account_details WHERE user_id = ". $row['added_by'];

    try{
        $queryAuthor = $db->prepare($sqlAgent);
    ...
    try{
        ...
        $queryCategory->setFetchMode(PDO::FETCH_ASSOC);

        $rowCategory = $queryCategory->fetch();
    ...
    $Location = "SELECT * FROM fx_province";
    ...
    // Select posts
    $SqlPosts = "SELECT * FROM fx_posts WHERE status = 'Published' ORDER BY post_id DESC LIMIT ". $offset . ", " . $rec_limit;
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Your trusted resourceful companion on your real estate journey.">
    <meta name="author" content="">
    <meta name="generator" content="Jekyll">
    <title>Elimo Real Estate</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:site" content="elimo.rw">
    <meta name="twitter:creator" content="@">
    <meta name="twitter:title" content="Elimo Real Estate">
    <meta name="twitter:description" content="Your trusted resourceful companion on your real estate journey.">
    <meta name="twitter:image" content="images/banner-2.jpg">
    <!-- Facebook -->
    <meta property="og:url" content="home-01.php">
    <meta property="og:title" content="Elimo Real Estate">
    <meta property="og:description" content="Your trusted resourceful companion on your real estate journey.">
    <meta property="og:type" content="website">
    <meta property="og:image" content="images/banner-2.jpg">
  ...
  <body>
              ...
              <div class="collapse navbar-collapse mt-3 mt-xl-0" id="primaryMenu02">
                <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0 active"href="index.php">Home</a>
                  </li>
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                  ...
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0"href="team.php">Team</a>
                  </li>
                  <!-- <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0"href="#">Shop</a>
                  </li> -->
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0"href="blog.php">Blog</a>
                  </li>
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0"href="faqs.php">FAQ's</a>
                  </li>
                  <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item py-2 py-xl-5 px-0 px-xl-3">
                    <a class="nav-link p-0"href="contact-us.php">Contact</a>
                  </li>
                </ul>
                <div class="d-block d-xl-none">
                  ...
                  <a class="nav-link dropdown-toggle mr-md-2 pr-2 pl-0 pl-lg-2" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php if($_SESSION['la']=='english'){ echo "English"; } else { echo "French";} ?>
                  </a>
                  <div class="dropdown-menu dropdown-sm dropdown-menu-right" aria-labelledby="bd-versions">
                    <a class="dropdown-item <?php if($_SESSION['la']=='english'){ echo "active"; } ?>" href="index.php?la=english"><?=$lang['lang-eng']?></a>
                    <a class="dropdown-item <?php if($_SESSION['la']=='french'){ echo "active"; } ?>" href="index.php?la=french"><?=$lang['lang-fre']?></a>
                  </div>
                </li>
                    <li class="divider"></li>
                    <li class="nav-item ">
                      <a class="nav-link pl-3 pr-2" href="https://agency.elimo.rw/">Sign In</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <ul class="navbar-nav flex-row ml-auto align-items-center justify-content-lg-end flex-wrap py-2">
                ...
                <!-- <li class="nav-item mr-auto mr-lg-6">
                  <a class="nav-link px-2 position-relative" href="#">
                    <i class="fal fa-shopping-cart fs-large-2"></i>
                    <span class="badge badge-yellow badge-circle badge-absolute">1</span>
                  </a>
                </li> -->
              </ul>
            </div>
    ...
    <main id="content">
      <section class="d-flex flex-column">
        <div style="background-image: url('images/elimo-2.jpg')"
	     class="bg-cover d-flex align-items-center custom-vh-100">
          <div class="container pt-lg-15 py-8" data-animate="zoomIn">
            <p class="text-white fs-md-18 fs-14 font-weight-500 letter-spacing-367 mb-2 text-center text-uppercase"><?=$lang['let_us_help_you'];?></p>
            <h2 class="text-white display-2 text-center mb-sm-5 mb-5"><?=$lang['find_dream_home'];?></h2>
            <img class="mxw-180 d-block mx-auto mt-4 mb-6" src="images/line-01.png" alt="">
            <form class="property-search py-lg-0 z-index-2 position-relative d-none d-lg-block pt-5" action="search-results.php" method="GET">
              <div class="row no-gutters">
                <div class="col-md-12 col-lg-8 col-xl-8">
                  <input class="search-field" type="hidden" name="label" value="for-rent"
						       data-default-value="for-sale">
                  <ul class="nav nav-pills property-search-status-tab">
                   ...
                   data-toggle="pill" data-value="for-sale">
                    ...
                    <li class="nav-item bg-dark rounded-top" role="presentation">
                      <a href="developments.php" role="tab" aria-selected="true"
                   class="nav-link btn shadow-none rounded-bottom-0 text-btn-focus-secondary text-uppercase d-flex align-items-center fs-13 rounded-bottom-0 bg-active-white text-active-secondary letter-spacing-087 flex-md-1 px-4 py-2"
                    data-value="developments">
                        <svg class="icon icon-villa fs-22 mr-2">
                          <use xlink:href="#icon-villa"></use>
                        </svg>
                        <?=$lang['developments'];?>
               ...
               <div class="col-md-6 col-lg-2 col-xl-2 pt-6 pt-lg-0 order-1">
                  ...
                  <div class="col-md-6 col-lg-2 col-xl-2 pt-6 pt-lg-0 order-1">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                      ...
                      <?php foreach ($db->query($PropertyTypes) as $key => $propertyType) { ?>
                        <option value="<?php echo $propertyType['id']; ?>"><?php echo $propertyType['name']; ?></option>
                      <?php } ?>
                  ...
                  <div class="col-md-6 col-lg-2 col-xl-2 pt-6 pt-lg-0 order-2">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                      title="Select" data-style="p-0 h-24 lh-17 text-dark" name="province" id="province">
                  ...
                  <div class="col-md-6 col-lg-2 col-xl-2 pt-6 pt-lg-0 order-2">
                    ...
                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                      title="Select" data-style="p-0 h-24 lh-17 text-dark" name="district" id="district">
                      <!-- <?php foreach ($db->query($Area) as $key => $area) { ?>
                 ...
                 aria-controls="advanced-search-filters-4">
                  ...
                  <div id="advanced-search-filters-4" class="col-12 pt-4 pb-sm-4 order-sm-5 order-4 collapse"
                    ...
                    <div class="row">
                      <div class="col-sm-2 col-lg-2 pt-6">
                      ...
                      <div class="col-sm-2 col-lg-2 pt-6">
                        ...
                        <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
									        title="All Bathrooms" data-style="p-0 h-24 lh-17 text-dark" name="baths">
                          <option value="">Any</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
                     ...
                     <div class="col-sm-6 col-lg-6 pt-6">
                        ...
                        <input type="text" name="ref"
                         ...
                         placeholder="Enter Property Ref...">
                      </div>
                    </div>
            ...
            <form class="property-search property-search-mobile d-lg-none z-index-2 position-relative bg-white rounded mx-md-10"  action="search-results.php" method="GET">
              <div class="row align-items-lg-center" id="accordion-4-mobile">
                <div class="col-12">
                  <div class="form-group mb-0 position-relative">
                    ...
                    <select class="form-control border shadow-none form-control-lg pr-9 pl-11 selectpicker bg-transparent"
                        title="View Properties" data-style="btn-lg py-2 h-52 bg-transparent" name="label" required>
                        <option value="for-sale">Properties For Sale</option>
                        <option value="for-rent">Properties For Rent</option>
                      </select>
                    <button type="submit"
                  ...
                  <!-- <div class="row mx-n2">
                    <div class="col-sm-6 pt-4 px-2">
                      <select class="form-control border shadow-none form-control-lg selectpicker bg-transparent"
								        title="Select" data-style="btn-lg py-2 h-52 bg-transparent" name="label">
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image">
                ...
                <div class="bg-overlay-gradient-1 bg-hover-overlay-gradient-3 rounded-lg card-img">
                  <img src="https://agency.elimo.rw/resource/property-files/<?php echo $row['image']; ?>" alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay d-flex flex-column justify-content-between">
                    <div>
                      <span class="badge mr-1 badge-orange"><?php echo $row['label']; ?></span>
                      <span class="badge mr-2 badge-primary"><?php echo ($row['featured']=='Yes'?'Featured':''); ?></span>
                    </div>
                    <ul class="list-inline mb-0 hover-image text-center">
                      <!-- <li class="list-inline-item">
                        <a href="#"
                                       class="w-52px h-52 rounded-circle d-inline-flex align-items-center justify-content-center text-heading bg-white bg-hover-primary hover-white"
                    ...
                    <ul class="list-inline d-flex mb-0 flex-wrap px-2 mr-n5">
                      <li class="list-inline-item text-white font-weight-500 fs-13 d-flex align-items-center mr-5"
                        ...
                        <svg class="icon icon-bedroom fs-18 text-yellow mr-1">
                      ...
                      <li class="list-inline-item text-white font-weight-500 fs-13 d-flex align-items-center mr-5"
                        ...
                        <svg class="icon icon-shower fs-18 text-yellow mr-1">
                      ...
                      <li class="list-inline-item text-white font-weight-500 fs-13 d-flex align-items-center mr-5"
                        ...
                        <svg class="icon icon-square fs-18 text-yellow mr-1">
                ...
                <div class="card-body p-0">
                  <h2 class="my-0 mt-1"><a href="property-detail.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['id']; ?>"
                                                 class="fs-16 text-dark hover-primary lh-2"><?php echo $row['title']; ?></a>
                  </h2>
                  <p class="text-gray-light font-weight-500 mb-1"><?php echo districtName($row['district']) ; ?></p>
                  <p class="fs-17 font-weight-bold text-heading mb-0"><?php echo $row['currency']; ?> <?php echo number_format((float)$row['price'], 0, '.', ',');?></p>
                </div>
              </div>
            </div>
              ...
              <div class="item py-4" data-animate="fadeInUp">
                <div class="card border-0 shadow-xxs-3">
                  <div class="position-relative d-flex align-items-end card-img-top">
                    <a href="article.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['post_id']; ?>" class="hover-shine">
                      <img src="https://agency.elimo.rw/resource/post-files/<?php echo $row['image']; ?>"
                                     alt="<?php echo $row['title']; ?>">
                    </a>
                    
                  </div>
                  <div class="card-body px-5 pt-3 pb-5">
                    <p class="mb-1 fs-13"><?php echo $row['date_created']; ?></p>
                    <h3 class="fs-18 text-heading lh-15 mb-1">
                      <a href="article.php?c=<?php echo $row['seo_url']; ?>&id=<?php echo $row['post_id']; ?>" class="text-heading hover-primary"><?php echo $row['title']; ?></a>
                    </h3>
                    ...
                    <a class="text-heading font-weight-500" href="#">Read more <i
           ...
           data-slick-options='{"slidesToShow": 6, "autoplay":true,"dots":false,"arrows":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":4}},{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 3}},{"breakpoint": 576,"settings": {"slidesToShow": 2}}]}'>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/british-high-commission.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/british-high-commission.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/dalberg.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/dalberg.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                 ...
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/usa.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                 ...
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/giz.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/dallaire.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/dallaire.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/global-health.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/global-health.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/gva.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/gva.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/ihs.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/ihs.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/kics.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/kics.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/un-eca.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/un-eca.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/vipp.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/vipp.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/wfp.jpg"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/wfp.jpg" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                 ...
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="images/mastercard.png" alt="Partner 1"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/sa-embassy.png"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 2">
                  <img src="images/sa-embassy.png" alt="Partner 2"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="images/wildlife.png"
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 3">
                  <img src="images/wildlife.png" alt="Partner 3"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
              ...
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                 ...
                 class="hover-image position-absolute pos-fixed-top" alt="Partner 5">
                  <img src="images/care.png" alt="Partner 5"
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
              ...
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item">
                  <img src="images/save-the-children.png" alt=""
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item">
                  <img src="images/unhcr.png" alt=""
                 class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
              ...
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item">
                  <img src="images/one-acre-fund.png" alt=""
                 class="image">
                </a>
              </div>
            </div>
      ...
      <section class="pt-7 pb-10 pb-xl-6 agents-section bg-primary">
        <div class="container container-xxl">
         ...
         data-slick-options='{"slidesToShow": 3, "dots":false,"arrows":false,"responsive":[{"breakpoint": 1600,"settings": {"slidesToShow":3,"dots":false}},{"breakpoint": 1200,"settings": {"slidesToShow":4,"dots":false}},{"breakpoint": 992,"settings": {"slidesToShow":3 ,"dots":false}},{"breakpoint": 768,"settings": {"slidesToShow": 2 ,"dots":false}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"dots":false}}]}'>
            ...
            <?php
                foreach ($db->query($AllAgents) as $row) { 
            ?> 
            ...
            <div class="py-8">
              <div class="card border-lg-0 shadow-hover-xs-4 hover-change-image" data-animate="flipInX">
                <div class="card-body text-center pt-6 pb-3 px-3">
                  <a href="agent-details.php?id=<?php echo $row['user_id']; ?>" class="d-inline-block mb-2">
                    <img src="https://agency.elimo.rw/resource/avatar/<?php echo $row['avatar']; ?>" alt="<?php echo $row['fullname']; ?>">
                  </a>
                  <a href="agent-details.php?id=<?php echo $row['user_id']; ?>"
               class="d-block fs-16 lh-1 text-dark mb-0 font-weight-500 hover-primary team-member"><?php echo $row['fullname']; ?></a>
                  <p class="mb-2 fs-13 text-danger"><?php echo $row['designation']; ?></p>
         ...
         data-slick-options='{"slidesToShow": 5,"arrows":false, "autoplay":false,"dots":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":3}},{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2}},{"breakpoint": 576,"settings": {"slidesToShow": 1}}]}'>
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                <img src="images/townhouse.jpg" class="card-img" alt="New York">
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                <img src="images/house.jpg" class="card-img" alt="Los Angeles">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                <img src="images/commercial.jpg" class="card-img" alt="San Jose">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                <img src="images/land.jpg" class="card-img" alt="Fort Worth">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
            ...
            <div class="box px-2" data-animate="fadeInUp">
              <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                <img src="images/apartment.jpg" class="card-img" alt="Kansas City">
                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
      ...
      <section class="pt-11 pb-13 bg-cover" style="background-image: url(images/banner-1.jpg)">
        <div class="container">
    ...
    <script src="js/filter-front.js"></script>
    ...
    <div class="position-fixed pos-fixed-bottom-right p-6 z-index-10">
      <a href="#"
       class="gtf-back-to-top bg-white text-yellow hover-white bg-hover-primary shadow p-0 w-52px h-52 rounded-circle fs-20 d-flex align-items-center justify-content-center"
       title="Back To Top"><i

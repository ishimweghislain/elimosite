...
//Select Category Data
    ...
    // $sqlSocial = "SELECT * FROM settings WHERE id = 1";
  
    // try{
    // $querySetting = $db->query($sqlSocial);

    // $querySetting->setFetchMode(PDO::FETCH_ASSOC);

    // $rowSetting = $querySetting->fetch();
    // echo $rowSocial;
    ...
    // $sqlSocial = "SELECT * FROM languages WHERE id = 1";
  
    // try{
    // $queryLang = $db->query($sqlSocial);
...
<html lang="en">
  ...
  <body>
    <header class="main-header position-absolute fixed-top m-0 navbar-dark header-sticky header-sticky-smart header-mobile-xl">
      <div class="sticky-area inner-page">
              ...
              <div class="tab-pane fade show active" id="login" role="tabpanel"
                ...
                <form class="form">
                  ...
                  <div class="d-flex mb-4">
                    ...
                    <a href="password-recovery.php" class="d-inline-block ml-auto text-orange fs-15">
                      Lost password?
                    </a>
                  </div>
